...
def plot_one_box(x, img, color=None, labels=None, line_thickness=3):
    ...
    if labels:
        ...
        t_size = cv2.getTextSize(combined_label, 0, fontScale=tl / 3, thickness=tf)[0]
        c2 = c1[0] + t_size[0], c1[1] - t_size[1] - 3
        
        # Draw filled rectangle for label background
        cv2.rectangle(img, c1, c2, color, -1, cv2.LINE_AA)  # filled
        
        # Draw the combined label text
        cv2.putText(img, combined_label, (c1[0], c1[1] - 2), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
